...
#'
#' @format A data frame with 11385 rows and 17 variables:
#' \describe{
#' }
#'
"uka_db_full"
...
#'
#' @format A data frame with 503 rows and 14 variables:
#' \describe{
#' }
#'
"kinome_mp_file_v1"
...
#'
#' @format A data frame with 530 rows and 26 variables:
#' \describe{
#' }
#'
"kinome_mp_file_v3"
